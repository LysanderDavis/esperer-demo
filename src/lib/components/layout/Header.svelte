			...
			<div class="hidden items-center space-x-8 text-white lg:flex">
				...
				{#if $user}
					<button
						...
						disabled={loading}
						class="rounded-lg border border-white px-4 py-2 text-sm text-white transition-all hover:border-gray-700 hover:text-black focus:ring-2 focus:ring-gray-300 focus:outline-none disabled:opacity-50"
					>
